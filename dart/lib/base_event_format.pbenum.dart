...
class EventType extends $pb.ProtobufEnum {
  ...
  static const EventType STOP_CHARGE_REQUEST = EventType._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STOP_CHARGE_REQUEST');
  ...
  static const EventType BOOT_NOTIFICATION_REQUEST = EventType._(23, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BOOT_NOTIFICATION_REQUEST');
  static const EventType LOG = EventType._(24, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LOG');
  static const EventType AUTHORIZE_REQUEST = EventType._(25, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AUTHORIZE_REQUEST');
  static const EventType AUTHORIZE_RESPONSE = EventType._(26, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AUTHORIZE_RESPONSE');
  static const EventType CHECK_AVAILABILITY_REQUEST = EventType._(27, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CHECK_AVAILABILITY_REQUEST');
  static const EventType CHECK_AVAILABILITY_RESPONSE = EventType._(28, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CHECK_AVAILABILITY_RESPONSE');
  static const EventType START_TRANSACTION_REQUEST = EventType._(29, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'START_TRANSACTION_REQUEST');
  static const EventType START_TRANSACTION_RESPONSE = EventType._(30, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'START_TRANSACTION_RESPONSE');
  static const EventType EV_CHARGE_STATUS = EventType._(31, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'EV_CHARGE_STATUS');
  static const EventType NOTIFY_CHARGE_POINT_STATE_CHANGE = EventType._(32, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NOTIFY_CHARGE_POINT_STATE_CHANGE');
  static const EventType STOP_TRANSACTION_REQUEST = EventType._(33, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STOP_TRANSACTION_REQUEST');
  static const EventType STOP_TRANSACTION_RESPONSE = EventType._(34, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STOP_TRANSACTION_RESPONSE');
