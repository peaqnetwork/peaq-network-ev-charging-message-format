...
_CHARGEPOINTSTATE_CHARGEPOINTSENTRY = _CHARGEPOINTSTATE.nested_types_by_name['ChargePointsEntry']
_CHARGEPOINT = DESCRIPTOR.message_types_by_name['ChargePoint']
_CHARGEPOINT_CONNECTORSENTRY = _CHARGEPOINT.nested_types_by_name['ConnectorsEntry']
_CHARGEPOINT_TRANSACTIONSENTRY = _CHARGEPOINT.nested_types_by_name['TransactionsEntry']
_CHARGEPOINT_AUTHLISTENTRY = _CHARGEPOINT.nested_types_by_name['AuthListEntry']
...
ChargePointState = _reflection.GeneratedProtocolMessageType('ChargePointState', (_message.Message,), {
  ...
  'ChargePointsEntry' : _reflection.GeneratedProtocolMessageType('ChargePointsEntry', (_message.Message,), {
    'DESCRIPTOR' : _CHARGEPOINTSTATE_CHARGEPOINTSENTRY,
    '__module__' : 'charge_point_gateway_format_pb2'
    # @@protoc_insertion_point(class_scope:gateway.ChargePointState.ChargePointsEntry)
    })
  ,
...
_sym_db.RegisterMessage(ChargePointState.ChargePointsEntry)

ChargePoint = _reflection.GeneratedProtocolMessageType('ChargePoint', (_message.Message,), {

  'ConnectorsEntry' : _reflection.GeneratedProtocolMessageType('ConnectorsEntry', (_message.Message,), {
    'DESCRIPTOR' : _CHARGEPOINT_CONNECTORSENTRY,
    '__module__' : 'charge_point_gateway_format_pb2'
    # @@protoc_insertion_point(class_scope:gateway.ChargePoint.ConnectorsEntry)
    })
  ,

  'TransactionsEntry' : _reflection.GeneratedProtocolMessageType('TransactionsEntry', (_message.Message,), {
    'DESCRIPTOR' : _CHARGEPOINT_TRANSACTIONSENTRY,
    '__module__' : 'charge_point_gateway_format_pb2'
    # @@protoc_insertion_point(class_scope:gateway.ChargePoint.TransactionsEntry)
    })
  ,

  'AuthListEntry' : _reflection.GeneratedProtocolMessageType('AuthListEntry', (_message.Message,), {
    'DESCRIPTOR' : _CHARGEPOINT_AUTHLISTENTRY,
    '__module__' : 'charge_point_gateway_format_pb2'
    # @@protoc_insertion_point(class_scope:gateway.ChargePoint.AuthListEntry)
    })
  ,
  'DESCRIPTOR' : _CHARGEPOINT,
  '__module__' : 'charge_point_gateway_format_pb2'
  # @@protoc_insertion_point(class_scope:gateway.ChargePoint)
  })
_sym_db.RegisterMessage(ChargePoint)
_sym_db.RegisterMessage(ChargePoint.ConnectorsEntry)
_sym_db.RegisterMessage(ChargePoint.TransactionsEntry)
_sym_db.RegisterMessage(ChargePoint.AuthListEntry)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CHARGEPOINTSTATE_CHARGEPOINTSENTRY._options = None
  _CHARGEPOINTSTATE_CHARGEPOINTSENTRY._serialized_options = b'8\001'
  _CHARGEPOINT_CONNECTORSENTRY._options = None
  _CHARGEPOINT_CONNECTORSENTRY._serialized_options = b'8\001'
  _CHARGEPOINT_TRANSACTIONSENTRY._options = None
  _CHARGEPOINT_TRANSACTIONSENTRY._serialized_options = b'8\001'
  _CHARGEPOINT_AUTHLISTENTRY._options = None
  _CHARGEPOINT_AUTHLISTENTRY._serialized_options = b'8\001'
  _EVENTTYPE._serialized_start=3532
  _EVENTTYPE._serialized_end=3853
  ...
  _STOPCHARGEREQUESTACKDATA._serialized_end=2313
  _CHARGEPOINTSTATE._serialized_start=2316
  _CHARGEPOINTSTATE._serialized_end=2492
  _CHARGEPOINTSTATE_CHARGEPOINTSENTRY._serialized_start=2419
  _CHARGEPOINTSTATE_CHARGEPOINTSENTRY._serialized_end=2492
  _CHARGEPOINT._serialized_start=2495
  _CHARGEPOINT._serialized_end=2996
  _CHARGEPOINT_CONNECTORSENTRY._serialized_start=2768
  _CHARGEPOINT_CONNECTORSENTRY._serialized_end=2841
  _CHARGEPOINT_TRANSACTIONSENTRY._serialized_start=2843
  _CHARGEPOINT_TRANSACTIONSENTRY._serialized_end=2920
  _CHARGEPOINT_AUTHLISTENTRY._serialized_start=2922
  _CHARGEPOINT_AUTHLISTENTRY._serialized_end=2996
  _CONNECTORINFO._serialized_start=2998
  _CONNECTORINFO._serialized_end=3070
  _TRANSACTIONINFO._serialized_start=3073
  _TRANSACTIONINFO._serialized_end=3265
  _CONSUMERAUTHDATA._serialized_start=3267
  _CONSUMERAUTHDATA._serialized_end=3381
  _LOCALAUTHORIZATIONDATA._serialized_start=3383
  _LOCALAUTHORIZATIONDATA._serialized_end=3444
  _IDTAGINFO._serialized_start=3446
  _IDTAGINFO._serialized_end=3529
