...
pub struct VerificationMethod {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:document.VerificationMethod.unknown_fields)
    pub unknown_fields: ::protobuf::UnknownFields,
    // @@protoc_insertion_point(special_field:document.VerificationMethod.cached_size)
...
pub struct Signature {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:document.Signature.unknown_fields)
    pub unknown_fields: ::protobuf::UnknownFields,
    // @@protoc_insertion_point(special_field:document.Signature.cached_size)
    pub cached_size: ::protobuf::rt::CachedSize,
}
...
pub struct Metadata {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:document.Metadata.unknown_fields)
    pub unknown_fields: ::protobuf::UnknownFields,
    // @@protoc_insertion_point(special_field:document.Metadata.cached_size)
    pub cached_size: ::protobuf::rt::CachedSize,
}
...
impl ::protobuf::Message for Metadata {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.plugType.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.plugType);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.plugType.is_empty() {
            os.write_string(1, &self.plugType)?;
        }
        if !self.power.is_empty() {
...
pub struct Service {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:document.Service.unknown_fields)
    pub unknown_fields: ::protobuf::UnknownFields,
    // @@protoc_insertion_point(special_field:document.Service.cached_size)
    pub cached_size: ::protobuf::rt::CachedSize,
}
...
pub struct Document {
    ...
    // special fields
    // @@protoc_insertion_point(special_field:document.Document.unknown_fields)
    pub unknown_fields: ::protobuf::UnknownFields,
    // @@protoc_insertion_point(special_field:document.Document.cached_size)
    pub cached_size: ::protobuf::rt::CachedSize,
}
...
impl ::protobuf::Enum for ServiceType {
    ...
    fn values() -> &'static [Self] {
        static values: &'static [ServiceType] = &[
            ServiceType::p2p,
            ServiceType::payment,
...
impl ServiceType {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new_2::<ServiceType>("ServiceType", 0)
    }
}
...
impl Status {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new_2::<Status>("Status", 1)
    }
}
...
impl ::protobuf::Enum for VerificationType {
    ...
    fn values() -> &'static [Self] {
        static values: &'static [VerificationType] = &[
...
impl VerificationType {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new_2::<VerificationType>("VerificationType", 2)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\tR\x04hash\"f\n\x08Metadata\x12\x1a\n\x08plugType\x18\x01\x20\x01(\
    \tR\x08plugType\x12\x14\n\x05power\x18\x02\x20\x01(\tR\x05power\x12(\n\
    \x06status\x18\x03\x20\x01(\x0e2\x10.document.StatusR\x06status\"\xab\
    \x01\n\x07Service\x12\x0e\n\x02id\x18\x01\x20\x01(\tR\x02id\x12)\n\x04ty\
    pe\x18\x02\x20\x01(\x0e2\x15.document.ServiceTypeR\x04type\x12\x20\n\nst\
    ringData\x18\x03\x20\x01(\tH\0R\nstringData\x120\n\x08metadata\x18\x04\
    \x20\x01(\x0b2\x12.document.MetadataH\0R\x08metadataB\x11\n\x0fserviceEn\
    dpoint\"\x96\x02\n\x08Document\x12\x0e\n\x02id\x18\x01\x20\x01(\tR\x02id\
    \x12\x1e\n\ncontroller\x18\x02\x20\x01(\tR\ncontroller\x12N\n\x13verific\
    ationMethods\x18\x03\x20\x03(\x0b2\x1c.document.VerificationMethodR\x13v\
    erificationMethods\x121\n\tsignature\x18\x04\x20\x01(\x0b2\x13.document.\
    SignatureR\tsignature\x12-\n\x08services\x18\x05\x20\x03(\x0b2\x11.docum\
    ent.ServiceR\x08services\x12(\n\x0fauthentications\x18\x06\x20\x03(\tR\
    \x0fauthentications*1\n\x0bServiceType\x12\x07\n\x03p2p\x10\0\x12\x0b\n\
    \x07payment\x10\x01\x12\x0c\n\x08metadata\x10\x02*(\n\x06Status\x12\r\n\
    \tAVAILABLE\x10\0\x12\x0f\n\x0bUNAVAILABLE\x10\x01*R\n\x10VerificationTy\
    pe\x12\x1e\n\x1aEd25519VerificationKey2020\x10\0\x12\x1e\n\x1aSr25519Ver\
    ificationKey2020\x10\x01BYZWgithub.com/peaqnetwork/peaq-network-ev-charg\
    ing-message-format/golang/document;documentJ\xa2\r\n\x06\x12\x04\0\08\
    ...
    \x05\0\x02\x01\x12\x03\x07\x02\x0e\n\x0c\n\x05\x05\0\x02\x01\x01\x12\x03\
    \x07\x02\t\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03\x07\x0c\r\n\x0b\n\x04\
    \x05\0\x02\x02\x12\x03\x08\x02\x0f\n\x0c\n\x05\x05\0\x02\x02\x01\x12\x03\
    \x08\x02\n\n\x0c\n\x05\x05\0\x02\x02\x02\x12\x03\x08\r\x0e\n\n\n\x02\x05\
    \x01\x12\x04\x0b\0\x0e\x01\n\n\n\x03\x05\x01\x01\x12\x03\x0b\x05\x0b\n\
    \x0b\n\x04\x05\x01\x02\0\x12\x03\x0c\x02\x10\n\x0c\n\x05\x05\x01\x02\0\
    \x01\x12\x03\x0c\x02\x0b\n\x0c\n\x05\x05\x01\x02\0\x02\x12\x03\x0c\x0e\
    \x0f\n\x0b\n\x04\x05\x01\x02\x01\x12\x03\r\x02\x12\n\x0c\n\x05\x05\x01\
    \x02\x01\x01\x12\x03\r\x02\r\n\x0c\n\x05\x05\x01\x02\x01\x02\x12\x03\r\
    \x10\x11\n\n\n\x02\x05\x02\x12\x04\x10\0\x13\x01\n\n\n\x03\x05\x02\x01\
    \x12\x03\x10\x05\x15\n\x0b\n\x04\x05\x02\x02\0\x12\x03\x11\x02!\n\x0c\n\
    \x05\x05\x02\x02\0\x01\x12\x03\x11\x02\x1c\n\x0c\n\x05\x05\x02\x02\0\x02\
    \x12\x03\x11\x1f\x20\n\x0b\n\x04\x05\x02\x02\x01\x12\x03\x12\x02!\n\x0c\
    \n\x05\x05\x02\x02\x01\x01\x12\x03\x12\x02\x1c\n\x0c\n\x05\x05\x02\x02\
    \x01\x02\x12\x03\x12\x1f\x20\n\n\n\x02\x04\0\x12\x04\x15\0\x1a\x01\n\n\n\
    ...
    \x0e\x0f\n\x0b\n\x04\x04\0\x02\x01\x12\x03\x17\x02\x1c\n\x0c\n\x05\x04\0\
    \x02\x01\x06\x12\x03\x17\x02\x12\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03\
    \x17\x13\x17\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\x17\x1a\x1b\n\x0b\n\
    \x04\x04\0\x02\x02\x12\x03\x18\x02\x18\n\x0c\n\x05\x04\0\x02\x02\x05\x12\
    \x03\x18\x02\x08\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03\x18\t\x13\n\x0c\n\
    \x05\x04\0\x02\x02\x03\x12\x03\x18\x16\x17\n\x0b\n\x04\x04\0\x02\x03\x12\
    \x03\x19\x02\x20\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x03\x19\x02\x08\n\x0c\
    \n\x05\x04\0\x02\x03\x01\x12\x03\x19\t\x1b\n\x0c\n\x05\x04\0\x02\x03\x03\
    \x12\x03\x19\x1e\x1f\n\n\n\x02\x04\x01\x12\x04\x1c\0\x20\x01\n\n\n\x03\
    \x04\x01\x01\x12\x03\x1c\x08\x11\n\x0b\n\x04\x04\x01\x02\0\x12\x03\x1d\
    \x02\x1c\n\x0c\n\x05\x04\x01\x02\0\x06\x12\x03\x1d\x02\x12\n\x0c\n\x05\
    \x04\x01\x02\0\x01\x12\x03\x1d\x13\x17\n\x0c\n\x05\x04\x01\x02\0\x03\x12\
    \x03\x1d\x1a\x1b\n\x0b\n\x04\x04\x01\x02\x01\x12\x03\