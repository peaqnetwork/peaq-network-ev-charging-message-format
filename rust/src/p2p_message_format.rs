...
pub struct GetBalanceAckData {
    ...
    // @@protoc_insertion_point(field:p2p.GetBalanceAckData.success)
    pub success: bool,
    // special fields
...
pub struct GetPKAckData {
    ...
    // @@protoc_insertion_point(field:p2p.GetPKAckData.success)
    pub success: bool,
    // special fields
...
pub struct ReconnectAckData {
    // message fields
    // @@protoc_insertion_point(field:p2p.ReconnectAckData.data)
    pub data: ::std::string::String,
    // @@protoc_insertion_point(field:p2p.ReconnectAckData.success)
    pub success: bool,
    // special fields
