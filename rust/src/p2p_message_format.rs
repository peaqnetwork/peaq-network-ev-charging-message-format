...
pub struct IdentityChallengeData {
    // message fields
    // @@protoc_insertion_point(field:p2p.IdentityChallengeData.encrypted_number)
    pub encrypted_number: ::std::string::String,
    // special fields
...
impl IdentityChallengeData {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "encrypted_number",
            |m: &IdentityChallengeData| { &m.encrypted_number },
            |m: &mut IdentityChallengeData| { &mut m.encrypted_number },
        ));
...
impl ::protobuf::Message for IdentityChallengeData {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while !is.eof()? {
            ...
            match tag {
                10 => {
                    self.encrypted_number = is.read_string()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if !self.encrypted_number.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.encrypted_number);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.unknown_fields());
        self.cached_size.set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.encrypted_number.is_empty() {
            os.write_string(1, &self.encrypted_number)?;
        }
        os.write_unknown_fields(self.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn default_instance() -> &'static IdentityChallengeData {
        static instance: IdentityChallengeData = IdentityChallengeData {
            encrypted_number: ::std::string::String::new(),
            unknown_fields: ::protobuf::UnknownFields::new(),
            cached_size: ::protobuf::rt::CachedSize::new(),
        };
        &instance
...
pub struct IdentityResponseData {
    ...
    pub resp: ::protobuf::MessageField<Response>,
    // @@protoc_insertion_point(field:p2p.IdentityResponseData.incremented_number)
    pub incremented_number: ::std::string::String,
...
impl IdentityResponseData {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "incremented_number",
            |m: &IdentityResponseData| { &m.incremented_number },
            |m: &mut IdentityResponseData| { &mut m.incremented_number },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "signature",
...
impl ::protobuf::Message for IdentityResponseData {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while !is.eof()? {
            ...
            match tag {
                ...
                18 => {
                    self.incremented_number = is.read_string()?;
                },
                26 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.incremented_number.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.incremented_number);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.incremented_number.is_empty() {
            os.write_string(2, &self.incremented_number)?;
        }
        if !self.signature.is_empty() {
    ...
    fn default_instance() -> &'static IdentityResponseData {
        static instance: IdentityResponseData = IdentityResponseData {
            resp: ::protobuf::MessageField::none(),
            incremented_number: ::std::string::String::new(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0b2\r.p2p.ResponseR\x04resp\"B\n\x15IdentityChallengeData\x12)\n\x10en\
    crypted_number\x18\x01\x20\x01(\tR\x0fencryptedNumber\"\x86\x01\n\x14Ide\
    ntityResponseData\x12!\n\x04resp\x18\x01\x20\x01(\x0b2\r.p2p.ResponseR\
    \x04resp\x12-\n\x12incremented_number\x18\x02\x20\x01(\tR\x11incremented\
    Number\x12\x1c\n\tsignature\x18\x03\x20\x01(\tR\tsignature\":\n\x08Respo\
    nse\x12\x14\n\x05error\x18\x01\x20\x01(\x08R\x05error\x12\x18\n\x07messa\
    ge\x18\x02\x20\x01(\tR\x07message\"\xe0\x01\n\x10TransactionValue\x12\
    \x1b\n\ttoken_num\x18\x01\x20\x01(\tR\x08tokenNum\x12\x17\n\x07tx_hash\
    \x18\x02\x20\x01(\tR\x06txHash\x12>\n\ntime_point\x18\x03\x20\x01(\x0b2\
    \x1f.p2p.TransactionValue.TimePointR\ttimePoint\x12\x1b\n\tcall_hash\x18\
    \x04\x20\x01(\tR\x08callHash\x1a9\n\tTimePoint\x12\x16\n\x06height\x18\
    \x01\x20\x01(\x03R\x06height\x12\x14\n\x05index\x18\x02\x20\x01(\x03R\
    \x05index*\xdb\x01\n\tEventType\x12\x13\n\x0fCHARGING_STATUS\x10\0\x12\
    \x17\n\x13SERVICE_REQUEST_ACK\x10\x01\x12\x18\n\x14SERVICE_DELIVERY_ACK\
    \x10\x02\x12\x15\n\x11SERVICE_REQUESTED\x10\x03\x12\x15\n\x11SERVICE_DEL\
    IVERED\x10\x04\x12\x0f\n\x0bSTOP_CHARGE\x10\x05\x12\x18\n\x14STOP_CHARGE\
    _RESPONSE\x10\x06\x12\x16\n\x12IDENTITY_CHALLENGE\x10\x07\x12\x15\n\x11I\
    DENTITY_RESPONSE\x10\x08BWZUgithub.com/peaqnetwork/peaq-network-ev-charg\
    ing-message-format/golang/message;messageJ\xf0\x12\n\x06\x12\x04\0\0J\
    \x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x02\0\